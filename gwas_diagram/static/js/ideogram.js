...
//var url = 'http://0.0.0.0:9000/v1/plotting_data?parent_term=Cancer|Cardiovascular%20measurement'
...
function drawDiagram(url) {
  getResponse(url).then(data => ideogram = new Ideogram({
    organism: 'human',
    chromosomeScale: 'relative',
    chrWidth: 10,
    chrHeight: 1000,
    annotationTracks: data.annotationTracks,
    annotations: data.annotations,
    annotationHeight: 3,
    annotationsLayout: data.annotationsLayout,
    barWidth: 5
...
var ideogram = new Ideogram({
  ...
  chrWidth: 10,
  chrHeight: 500,
  annotationTracks: window.response.annotationTracks,
  annotations: window.response.annotations,
  annotationHeight: 3,
  annotationsLayout: window.response.annotationsLayout
});
